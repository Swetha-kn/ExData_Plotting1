...
#plotting plot1 the histogram graph
par(mfrow=c(1,1))
hist(EPC_DT$Global_active_power,freq = TRUE, main = "Global Active Power",col = "red",xlab = "Global Active Power (Kilowatts)")

#send file to plot1.png file
